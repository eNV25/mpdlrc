...
//go:generate go run github.com/env25/mpdlrc/internal/cmd/bundle -o bundle.go -prefix "" github.com/fhs/gompd/v2/mpd
...
func (cl *CommandList) End() error {
	...
	for i := range cmds {
		cmdID, cmdErr := cl.client.cmd(cmds[i].cmd)
		if cmdErr != nil {
			return cmdErr
		}
