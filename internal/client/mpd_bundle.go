...
//go:generate bundle -o mpd_bundle.go github.com/env25/gompd/v2/mpd
...
func (c *mpd_Client) ReadPicture(uri string) ([]byte, error) {
	offset := 0
	var data []byte
	for {
		// Read the data in chunks
